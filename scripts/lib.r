...
ipo4xcmsSet <- function(directory, parametersOutput, listArguments) {
  ...
  resultPeakpicking <- optimizeXcmsSet(mzfiles[1:2], peakpickingParametersUser, nSlaves = peakpickingParametersUser$nSlaves, subdir = "../IPO_results") # some images generated by IPO
